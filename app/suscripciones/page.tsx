    ...
    return (
      <main style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: '#3A5C2C', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '8px' }}>
            Tu plan mensual
          </div>
          <div style={{ fontSize: '36px', fontWeight: '900', color: '#3A5C2C' }}>
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <a href="/catalogo" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontSize: '14px' }}>
          ← Volver
        </a>
      </div>
      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <p style={{ color: '#8A7A6A', fontSize: '16px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                    <h3 style={{
                      fontSize: '18px',
                      fontWeight: '700',
                      color: planSeleccionado === p.id ? 'white' : '#2C1A0E',
                      margin: 0,
                    }}>
                      {p.nombre}
                    </h3>
                  ...
                  <p style={{
                    fontSize: '13px',
                    color: planSeleccionado === p.id ? 'rgba(255,255,255,0.7)' : '#8A7A6A',
                    margin: 0,
                  }}>
                    {p.descripcion}
                  </p>
                ...
                <div style={{ textAlign: 'right', flexShrink: 0, marginLeft: '16px' }}>
                  <div style={{
                    fontSize: '24px',
                    fontWeight: '900',
                    color: planSeleccionado === p.id ? '#C8842A' : '#2C1A0E',
                  }}>
                    ${p.precio.toLocaleString()}
                  </div>
                  <div style={{
                    fontSize: '11px',
                    color: planSeleccionado === p.id ? 'rgba(255,255,255,0.6)' : '#8A7A6A',
                  }}>
                    /mes
                  </div>
                </div>
