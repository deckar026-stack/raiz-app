    ...
    <main style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
          <a href="/" style={{ color: 'rgba(245,237,216,0.8)', textDecoration: 'none', fontSize: '15px', letterSpacing: '1px' }}>Inicio</a>
          ...
          <a href="/nosotros" style={{ color: 'rgba(245,237,216,0.8)', textDecoration: 'none', fontSize: '15px', letterSpacing: '1px' }}>Nosotros</a>
          <a href="/contacto" style={{ color: 'rgba(245,237,216,0.8)', textDecoration: 'none', fontSize: '15px', letterSpacing: '1px' }}>Contáctenos</a>
          <a href="/login" style={{
      ...
      <div style={{
        ...
        {[
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ fontSize: '16px', fontWeight: '700', color: '#f5edd8' }}>
                {p.nombre}
              </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '24px' }}>
          <a href="/nosotros" style={{ color: 'rgba(245,237,216,0.5)', textDecoration: 'none', fontSize: '13px' }}>Nosotros</a>
          <a href="/contacto" style={{ color: 'rgba(245,237,216,0.5)', textDecoration: 'none', fontSize: '13px' }}>Contacto</a>
          <a href="/login" style={{ color: 'rgba(245,237,216,0.5)', textDecoration: 'none', fontSize: '13px' }}>Productores</a>
        </div>
        <p style={{ fontSize: '13px', color: 'rgba(245,237,216,0.4)' }}>
          © 2026 Raíz SAS · Colombia
        </p>
      </div>
